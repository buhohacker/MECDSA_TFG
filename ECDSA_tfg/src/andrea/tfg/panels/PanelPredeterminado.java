...
public class PanelPredeterminado extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelFondoCurvas.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 0, 0), null));
        ...
        panelFondoMensaje.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 0, 0), null));
        ...
        panelFondoFirma.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 0, 0), null));
    ...
    public String devolverFirma1Curva() throws NoSuchAlgorithmException {
        ...
        if (botonP256.isSelected() == true) {
            ...
            System.out.println("Firma con P-256: " + ToStringJSON.arrayToJSON(signature) + '\n');
            res = ToStringJSON.arrayToJSON(signature);
        }
        ...
        if (botonSM2.isSelected() == true) {
            ...
            String msg = InputMensaje.getText();
            BigInteger[] signature = FirmaMensaje1Curva.firmaMsj(msg, n, P, a, cls.getClavePrivada());
            System.out.println("Firma con SM2: " + ToStringJSON.arrayToJSON(signature) + '\n');
            res = ToStringJSON.arrayToJSON(signature);
        }
        return res;
    }
    ...
    public String devolverFirma2Curvas() throws NoSuchAlgorithmException {
        ...
        if (botonP256.isSelected() && botonSM2.isSelected() && !botonSecp256r1.isSelected() && !botonSecp256k1.isSelected()) {
            ...
            System.out.println("Firma con P-256 y SM2: " + ToStringJSON.arrayToJSON(signature) + '\n');
            res = ToStringJSON.arrayToJSON(signature);
        }
        ...
        if (botonP256.isSelected() && !botonSM2.isSelected() && botonSecp256r1.isSelected() && !botonSecp256k1.isSelected()) {
            ...
            System.out.println(sacarMsg + msg + '\n');
            BigInteger[] signature = FirmaMensaje2Curvas.firmaMsj(msg, n1, n2, P1, P2, a1, a2, cls1.getClavePrivada(), cls2.getClavePrivada());
            System.out.println("Firma con P-256 y secp256r1: " + ToStringJSON.arrayToJSON(signature) + '\n');
            res = ToStringJSON.arrayToJSON(signature);
        }       
        // Aquí firmamos el mensaje si se selecciona el boton P256 y secp256r1.
        if (!botonP256.isSelected() && botonSM2.isSelected() && botonSecp256r1.isSelected() && !botonSecp256k1.isSelected()) {
            ...
            System.out.println(sacarMsg + msg + '\n');
            BigInteger[] signature = FirmaMensaje2Curvas.firmaMsj(msg, n1, n2, P1, P2, a1, a2, cls1.getClavePrivada(), cls2.getClavePrivada());
            System.out.println("Firma con SM2 y secp256r1: " + ToStringJSON.arrayToJSON(signature) + '\n');
            res = ToStringJSON.arrayToJSON(signature);
        }
        ...
        if (botonP256.isSelected() && !botonSM2.isSelected() && !botonSecp256r1.isSelected() && botonSecp256k1.isSelected()) {
            ...
            System.out.println(sacarMsg + msg + '\n');
            BigInteger[] signature = FirmaMensaje2Curvas.firmaMsj(msg, n1, n2, P1, P2, a1, a2, cls1.getClavePrivada(), cls2.getClavePrivada());
            System.out.println("Firma con P-256 y secp256k1: " + ToStringJSON.arrayToJSON(signature) + '\n');
            res = ToStringJSON.arrayToJSON(signature);
        }
        ...
        if (!botonP256.isSelected() && botonSM2.isSelected() && !botonSecp256r1.isSelected() && botonSecp256k1.isSelected()) {
            ...
            System.out.println(sacarMsg + msg + '\n');
            BigInteger[] signature = FirmaMensaje2Curvas.firmaMsj(msg, n1, n2, P1, P2, a1, a2, cls1.getClavePrivada(), cls2.getClavePrivada());
            System.out.println("Firma con SM2 y secp256k1: " + ToStringJSON.arrayToJSON(signature) + '\n');
            res = ToStringJSON.arrayToJSON(signature);
        }
        ...
        if (!botonP256.isSelected() && !botonSM2.isSelected() && botonSecp256r1.isSelected() && botonSecp256k1.isSelected()) {
            ...
            System.out.println(sacarMsg + msg + '\n');
            BigInteger[] signature = FirmaMensaje2Curvas.firmaMsj(msg, n1, n2, P1, P2, a1, a2, cls1.getClavePrivada(), cls2.getClavePrivada());
            System.out.println("Firma con secp256r1 y secp256k1: " + ToStringJSON.arrayToJSON(signature) + '\n');
            res = ToStringJSON.arrayToJSON(signature);
        }
        return res;
    }
