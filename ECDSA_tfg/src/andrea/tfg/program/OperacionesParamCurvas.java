...
public class OperacionesParamCurvas {
    ...
    public static BigInteger[] obtPtoBase(BigInteger p, BigInteger a, BigInteger b, BigInteger n) {
        ...
        System.out.println("Prueba metodo punto base." + ToStringJSON.arrayToJSON(l1) + "Lista dos: " + ToStringJSON.arrayToJSON(l2));
    ...
    public static BigInteger[] pruebaPtoBaseP(BigInteger p, BigInteger n, BigInteger a, BigInteger b) {
        ...
        do {
            ...
            punto[0] = r1;
            punto[1] = r2;
            System.out.println("Punto: " + ToStringJSON.imprimirPunto(punto));
           ...
           // G = OperacionesCE.puntoPorEscalar(punto, a, n, k);
            ...
            System.out.println("G: " + ToStringJSON.imprimirPunto(G)+'\n');
            ...
            */
            ...
            if (ToStringJSON.imprimirPunto(G).compareTo("(0,0)")!=0) { //&& ToStringJSON.imprimirPunto(compro).compareTo("(0,0") == 0
                flag = true;
            }
        } while (flag == false);
   ...
   public static BigInteger[] pruebaPtoBase(BigInteger p, BigInteger n, BigInteger a, BigInteger b) {
        ...
        } while (ToStringJSON.imprimirPunto(G).compareTo("(0,0)")==0 && ToStringJSON.imprimirPunto(comp).compareTo("(0,0)")==0);
