...
public class CurvaSecp256k1 {
    ...
    private BigInteger a = BigInteger.ZERO;	//// Esta curva se define como y^2 = x^3-3*x+b(modp) por eso a=-3.
    //private BigInteger c;			//// No tenemos el parámetro c porque estamos en cuerpos primos, ec. general --> y^2 = x^3+a*x+b
    private BigInteger b = BigInteger.valueOf(7);
    private BigInteger[] Pxy;
    // El punto base en coordenadas se ha sacado de https://safecurves.cr.yp.to/base.html
    ...
    public CurvaSecp256k1() {

        System.out.println("Creando la curva elíptica secp256k1..........");
        ...
        System.out.println("Curva elíptica secp256k1 creada!!\n");
