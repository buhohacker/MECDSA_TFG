 ...
 * @author Andrea
 */
public class PanelAvanzadoErroneo extends javax.swing.JPanel {

    /**
     * Creates new form panelAvanzado
     */
    public PanelAvanzadoErroneo() {
        initComponents();
    }
    ...
    public String firmarConInputParam() throws NoSuchAlgorithmException {
        ...
        if (botonUnoP256.isSelected() && botonDosP256.isSelected()) {
            ...
            */
            ...
            System.out.println("Imprimimos coords pto c1: " + OperacionesString.imprimirPunto(c1.getPxy()));
            //System.out.println("Prueba coords pto c1: " + ToStringJSON.imprimirPunto(ptoBaseC1) + '\n');
            System.out.println("Imprimimos coords pto c2: " + OperacionesString.imprimirPunto(c2.getPxy()) + '\n');
            
            // En este if comprobamos si existe el punto base, si no existe, es (0,0) por defecto --> else --> Mensaje de error.
            if((OperacionesString.imprimirPunto(c1.getPxy()).compareTo("(0,0)") != 0)
                    && (OperacionesString.imprimirPunto(c2.getPxy()).compareTo("(0,0)") != 0)) {
                
                System.out.println("Comprobamos los parámetros primera curva: " + "a1:" + c1.getA() + " b1:" + c1.getB() + " P1:" + OperacionesString.imprimirPunto(c1.getPxy()));
                ...
                System.out.println("Comprobamos los parámetros segunda curva: " + "a2:" + c2.getA() + " b2:" + c2.getB() + " P2:" + OperacionesString.imprimirPunto(c2.getPxy()) + '\n');
                ...
                res = OperacionesString.arrayToJSON(firma);
    ...
    private void botonFirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonFirmarActionPerformed
        ...
        if (InputMensaje.getText().isEmpty()) {
            ...
            try {
                ...
                Logger.getLogger(PanelAvanzadoErroneo.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
